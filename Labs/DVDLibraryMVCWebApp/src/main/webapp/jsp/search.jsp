        ...
        <div class="container">
            ...
            <div class="navbar">
                <ul class="nav nav-tabs">   
                    <li role="presentation"><a href="${pageContext.request.contextPath}/index">Index</a></li><!--so now the home path will resolve to an endpoint in our controller -->
            ...
            <!-- removed some of the tabbed links for ajax version-->
            <div class="row">
                <div class="col-md-6">
                    <h4>My DVDs</h4>
                ...
                <div class="col-md-6">
                    ...
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">                     
                                <input type="text" class="form-control" name="title" id="search-title" path="title" placeholder="Film Title"/>          
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6"<!--this div is just to create spacing in the grid -->   <!--this placeholder is just in case we don't have a value already  -->                       
                                 <input type="text" class="form-control" name="releaseDate" id="search-releaseDate" path="releaseDate" placeholder="Release Date (form must be YYYY-MM-DD)"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6"><!--this div is just to create spacing in the grid -->   <!--this placeholder is just in case we don't have a value already  -->                       
                                <input type="text" class="form-control" name="mpaaRating" id="search-rating" path="title" placeholder="MPAA Rating"/>
                                <!--now we will put in all of our errors in the view, and we will need indicate all of the "paths" - why is the param called a path?-->   
                            </div>
                        </div> 
                        <div class="form-group">
                            ...
                            <div class="col-md-6"><!--this div is just to create spacing in the grid -->   <!--this placeholder is just in case we don't have a value already  -->                       
                                <input type="text" class="form-control" name="director" id="search-director" path="director" placeholder="Directed By"/>
                                <!--now we will put in all of our errors in the view, and we will need indicate all of the "paths" - why is the param called a path?-->   
                            </div>
                        </div> 
                        <div class="form-group">
                            ...
                            <div class="col-md-6"><!--this div is just to create spacing in the grid -->   <!--this placeholder is just in case we don't have a value already  -->                       
                                <input type="text" class="form-control" name="studio" id="search-studio" path="studio" placeholder="Studio"/>
                                <!--now we will put in all of our errors in the view, and we will need indicate all of the "paths" - why is the param called a path?-->   
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="search-note" class="col-md-4 control-label">User Review</label>
                            <div class="col-md-6"><!--this div is just to create spacing in the grid -->   <!--this placeholder is just in case we don't have a value already  -->                       
                                <input type="text" class="form-control" name="note" id="search-note" path="note" placeholder="User Notes"/>
                                <!--now we will put in all of our errors in the view, and we will need indicate all of the "paths" - why is the param called a path?-->   
                                <!---->
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-6">
                                <button type="submit" id="search-button" class="btn btn-primary">Search for DVD</button>
                            </div>
                        </div>
                    </form>
                </div>
