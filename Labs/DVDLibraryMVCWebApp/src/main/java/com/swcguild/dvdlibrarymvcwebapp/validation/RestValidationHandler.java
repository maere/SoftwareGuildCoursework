 ...
 */
package com.swcguild.dvdlibrarymvcwebapp.validation;
...
public class RestValidationHandler {
    ...
    @ResponseBody()//will send back a JSON object          /this method takes an exception(s) as an argument
    public ValidationErrorContainer processValidationErrors(MethodArgumentNotValidException e){
        ...
        return errors; //is this the same errors as we have in the JS? is the JS expecting errors vs. eg. vErrors?
    }
