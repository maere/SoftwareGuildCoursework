...
public class AddressBookDbImpl implements AddressBookAPI {
    ...
    public Address getAddress(int idNumber) { //java wants me to change the return type for this method toList
        ...
        try {
            return jdbcTemplate.queryForObject(SQL_GET_ADDRESS, new AddressMapper());
    ...
    private static final class AddressMapper implements ParameterizedRowMapper<Address> {
        ...
        public Address mapRow(ResultSet rs, int i) throws SQLException {
            ...
            address.setFirstName(rs.getString("last_name"));
            address.setFirstName(rs.getString("street"));
            address.setFirstName(rs.getString("city"));
            address.setFirstName(rs.getString("state"));
            address.setFirstName(rs.getString("zip"));
