...
//    TaxesDAOFileImpl taxObjRef = new TaxesDAOFileImpl();
    ...
    public OrderFactoryMini(Materials daoMaterials, Taxes daoTaxes){
        ...
        try {
            ...
            Logger.getLogger(OrderFactoryMini.class.getName()).log(Level.SEVERE, null, ex);
        }
