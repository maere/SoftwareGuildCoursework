...
public class LuckySevensRefactored {
    ...
    //constructor 
        public LuckySevensRefactored(int die1, int die2, int rollsCounter, int maxMoney, int peakRolls){
        this.die1 = die1;
        this.die2 = die2;
...
// loop construct to keep playing until the money is gone.
      public boolean playOn(int playerMoney){
        ...
        public int moneyTracker(int playerMoney){
            if (die1 + die2 == 7)
            {
                playerMoney = playerMoney + 4;
            }    
        ...
        public int maxDollars(int playerMoney, int maxMoney){
 ...
 // pulled this out of max Rolls and need to put back into main?
        ...
        */
        public static void outOfMoney(int playerMoney<=0){
            System.out.println("You can't play--you're out of money.");
        }
