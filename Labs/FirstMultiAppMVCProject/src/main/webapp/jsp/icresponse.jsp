        ...
        <div class="container">
            ...
            <div>
                <div class="starter-template">
                    ...
                    <p>Below is an amortization table of your investment.</p><br />

                    <c:forEach var="i" items="${list}">
                        <c:out value="Year #: ${i.year}"></c:out><br/>
                        <c:out value="Starting balance: ${i.currentBalance}"></c:out><br/>           
                        <c:out value="Interest Earned for the year: ${i.yearInterest}"></c:out><br/>           
                        <c:out value="Ending Balance: ${i.endPrinciple}"></c:out><br/>
                            <hr>
                    </c:forEach>
                            
                    <form action="InterestCalcController">
                        <button type="submit" id="add-button" class="btn btn-default" value="Try another Scenario">Try A New Scenario</button>
                        </br>
                        </br>
                    </form>
                </div>
