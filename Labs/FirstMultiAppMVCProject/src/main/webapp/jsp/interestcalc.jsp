        ...
        <div class="container">
            ...
            <div>
                <div class="starter-template">
                    ...
                    <p>This calculator will allow you to run different investment scenarios, and return an amortization schedule.</p><br />

                    <sf:form action="InterestCalcController" method="post" class="form-horizontal" role="form" modelAttribute="viewbag" >
                        <div class="form-group">
                            <div class="col-md-8"><!--this div is just to create spacing in the grid -->   <!--this placeholder is just in case we don't have a value already  -->                       
                                ...
                                How much money will you be investing?<br/> <!-- float-->
                                <input type="text" name="moneyInvested" />
                                <br/>
                                <br/>
                                How many years will you invest?<br/> <!-- int -->
                                <input type="text" name="yearsInvested" />
                                <br/>
                                <br/>
                                What is your annual interest rate?<br/> <!-- float-->
                                <input type="text" name="interestRate" />
                                <br/>
                                <br/>
                                <!--the text value of name="" is what will be sent to server -->
                                <br/>
                                <button type="submit" id="add-button" class="btn btn-default" value="Calculate Interest" />Calculate Interest</button>  <!--this is what the submit button says on it -->
