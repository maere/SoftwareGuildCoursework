        ...
        <div class="container">
            ...
            <div>
                <div class="starter-template">
                    ...
                    <p>We'll tell you how much to tip for your service based on a percentage.</p><br />

                    <sf:form action="TipCalcController" method="post" class="form-horizontal" role="form" modelAttribute="viewbag" >
                        <div class="form-group">
                            <div class="col-md-8"><!--this div is just to create spacing in the grid -->   <!--this placeholder is just in case we don't have a value already  -->                       
                                ...
                                Enter the value of your meal or service:<br/> <!-- float-->
                                <input type="number" step=".01" name="amountOfService" /><br/>
                                <br/>
                                What percentage would you like to tip? (enter as a whole number)<br/> <!-- int -->
                                <input type="input" name="tipPercentage" /><br/>
                                <br/>
                                <!--the text value of name="" is what will be sent to server -->
                                <br/>
                                <button type="submit" id="add-button" class="btn btn-default">Calculate Tip</button>
                                <!--sf errors-->
                            </div>
