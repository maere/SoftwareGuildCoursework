                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-4 col-md-8">
                                    <button type="submit" id="add-button" class="btn btn-default">Create Contact</button><!--this add-button id will connect us to our js on click -->
                                </div> 
                            </div>
                        </form>
...
<!--these have to be in the order where each subsequent thing might rely on things coming before...jQuery is the base, then bootstrap, then custom -->
    </body>
</html>
