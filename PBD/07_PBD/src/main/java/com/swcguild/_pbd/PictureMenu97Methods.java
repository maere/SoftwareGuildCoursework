 ...
 * @author apprentice
 */
public class PictureMenu97Methods {
    ...
    //(Answer in a comment: You get two butterflies. 
		}
		else if ( choice == 2 )
		{
			elephant();
  ...
  //start methods
    ...
    Change the code in the if statement for choice 1 so that it calls the 'butterfly' function twice 
