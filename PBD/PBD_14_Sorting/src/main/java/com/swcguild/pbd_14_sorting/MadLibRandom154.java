 ...
 * @author apprentice
 */
public class MadLibRandom154 {

    public static void main(String[] args) {
//int mi = 0 + (int) (Math.random() * males.length);//we cast to int bc Math.random()
//returns a double (between 0 and 1.00) - * number turns it into number up to that number -- +1 for 1-5 or 0+ for arrays to pull 0-4
